                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card position-ralative">
                            ...
                            <div class="card-body">
                                ...
                                <?php $sql1 = "select t1.user_id, t1.rating,t1.comments,t2.name,t2.email from reviews t1 join users t2 on t1.user_id = t2.id where restaurant_id = ".$row["id"]; ?>
                                ...
                                <?php if(sizeof($reviews)>0){
                                    ...
                                    for ($j=0; $j < sizeof($reviews); $j++) { 
                                        ...
                                        <div class="comment-container position-ralative">
                                            <?php if($isLoggedIn && $user["id"]==$row1["user_id"]):?>
